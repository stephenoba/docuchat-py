...
def test_process_document_success(mock_split, mock_async_run, mock_session_local):
    # 1. Setup IDs
    user_id = uuid4()
    doc_id = uuid4()
    ...
    # Expect 2 commits: one for status=PROCESSING, one for the final result
